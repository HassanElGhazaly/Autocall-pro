    ...
    <div className="min-h-screen bg-[#030303] text-white selection:bg-purple-500/30 font-sans overflow-x-hidden">
      ...
      <nav className="flex items-center justify-between px-8 py-6 border-b border-white/10 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-400">
          ...
          <a href="tel:+16465170133" className="flex items-center gap-2 text-purple-400 hover:text-purple-300 transition font-bold">
            <Phone size={16} /> +1 (646) 517-0133
          </a>
          <Link to="/signup" className="px-5 py-2 rounded-full border border-white/10 hover:bg-white/5 transition text-white">
            Contractor Login
          </Link>
        </div>
      </nav>
      ...
      <section className="px-8 pt-32 pb-20 text-center max-w-5xl mx-auto">
        ...
        >
          <Link to="/signup" className="bg-white text-black font-bold px-10 py-4 rounded-full transition-all hover:bg-purple-500 hover:text-white hover:scale-105 flex items-center gap-2">
      ...
      {/* Live Demo Section */}
      <section className="px-8 py-20 bg-purple-600/5 border-y border-purple-500/10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-black mb-8">Talk to Alex Live</h2>
          <div className="flex flex-col items-center justify-center gap-6">
            <a 
              href="tel:+16465170133" 
              className="group relative flex items-center gap-4 px-8 py-6 bg-white text-black rounded-3xl hover:scale-105 transition-transform shadow-2xl shadow-purple-500/20"
            >
              <div className="relative">
                <div className="absolute inset-0 bg-purple-500 rounded-full animate-ping opacity-20"></div>
                <div className="relative w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center text-white">
      ...
      <section id="features" className="px-8 py-32 bg-white/[0.01]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-3xl bg-white/[0.03] border border-white/10 hover:border-purple-500/50 transition group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="bg-[#030303] px-4">
                <span className="text-xs font-bold text-purple-500 uppercase tracking-widest mb-2 block">Step 1</span>
      ...
      <section className="px-8 py-12">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-purple-900/40 to-blue-900/40 border border-purple-500/30 rounded-3xl p-8 text-center backdrop-blur-sm">
          <h3 className="text-2xl md:text-3xl font-black mb-4 text-white">The 5-Job Guarantee</h3>
          <p className="text-lg text-gray-200 leading-relaxed">
            If Alex doesn't save you at least <span className="text-purple-400 font-bold">5 jobs</span> in your first 30 days, we'll refund every penny. <span className="underline decoration-purple-500 underline-offset-4">No questions asked.</span>
          </p>
        </div>
      </section>
      ...
      <section id="pricing" className="px-8 py-32 relative">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
            ...
            {/* Service Team Plan */}
            <div className="p-10 rounded-3xl bg-purple-600/10 border-2 border-purple-500/50 flex flex-col items-start relative overflow-hidden hover:bg-purple-600/20 transition">
              ...
              <p className="text-purple-100 text-sm mb-8">Your 24/7 AI Sales Team. Fully integrated with your CRM and Calendar. Replaces a $3k/mo human receptionist.</p>
              <div className="space-y-4 mb-10 flex-1">
              ...
              <Link to="/signup" className="w-full py-4 rounded-2xl bg-purple-600 hover:bg-purple-500 text-white font-bold transition shadow-xl shadow-purple-600/20 text-center">Go Pro Now</Link>
            </div>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="p-6 text-sm font-bold uppercase tracking-widest text-purple-400">Alex (AI)</th>
      ...
      <footer className="px-8 py-16 border-t border-white/10 text-center text-gray-600 text-sm">
        <div className="mb-6 flex flex-col items-center gap-4">
          <a href="tel:+16465170133" className="text-xl font-bold text-white hover:text-purple-400 transition flex items-center gap-2">
            <Phone size={20} className="text-purple-500" /> +1 (646) 517-0133
          </a>
