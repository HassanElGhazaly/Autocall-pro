  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white flex flex-col items-center justify-center p-6 font-sans">
      <Link to="/" className="flex items-center gap-2 mb-12">
        ...
        <span className="text-xl font-bold tracking-tighter text-white">AutoCall<span className="text-green-500">.pro</span></span>
      </Link>
      ...
      >
        <h1 className="text-3xl font-black mb-2 text-center text-white">Welcome Back</h1>
        <p className="text-gray-400 text-center mb-8">Login to manage your AI Front-Desk.</p>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:border-purple-500 transition text-white"
