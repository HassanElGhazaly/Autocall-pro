      ...
      >
        ...
        <form onSubmit={handleEmailSignup} className="space-y-4">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-2xl bg-purple-600 hover:bg-purple-500 text-white font-bold transition shadow-xl shadow-purple-600/20 flex items-center justify-center gap-2"
          >
